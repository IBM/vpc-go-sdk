...
# IBM Cloud VPC Go SDK Version 0.11.0
...
Consider using v0.11.0 from now on. Refrain from using commands like `go get -u ..` and `go get ..@latest` as you will not get the latest release.
...
```
go get github.com/IBM/vpc-go-sdk@v0.11.0
```
